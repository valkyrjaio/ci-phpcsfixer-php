...
{
    /**
     * The complete set of rules the config is expected to produce.
     *
     * Any change, addition, or removal of a rule (or its options) must be
     * reflected here, otherwise the test will fail.
     *
     * @return array<string, bool|array<string, mixed>>
     */
    private static function expectedRules(string $header): array
    {
        return [
    ...
    public function testGetConfigUsesProvidedFinder(): void
    {
        $finder = new Finder();
